...
return opts.min+(opts.max-opts.min)*(pos/size);
	...
	console.log('complete 77');
}};

/*//hopper modified------------------------------------------------------------------------------
$.getScript("/public/js/easyui/hopper/easyui.extention.js", function(ignored, inStatusText){
	console.log('Loading ---------> /hopper/easyui.extention.js');
});*/
